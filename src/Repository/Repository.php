...
class Repository
{
     ...
     */
    public function __construct(string $class_name, Storage $storage, string $collection_class_name = Collection::class)
    {
    ...
    {
        $this->storage->insert($aggregate_root);
    ...
    {
        $this->storage->update($aggregate_root);
